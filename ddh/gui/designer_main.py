...
"font: 19pt \"DejaVu Sans\";")
        ...
        self.btn_map = QtWidgets.QPushButton(self.tab_map)
        self.btn_map.setMaximumSize(QtCore.QSize(250, 16777215))
        self.btn_map.setObjectName("btn_map")
        self.horizontalLayout_16.addWidget(self.btn_map)
        self.lbl_map_txt = QtWidgets.QLabel(self.tab_map)
        self.lbl_map_txt.setMaximumSize(QtCore.QSize(9002, 100))
        font = QtGui.QFont()
        ...
        font.setStrikeOut(False)
        font.setKerning(True)
        self.lbl_map_txt.setFont(font)
        self.lbl_map_txt.setStyleSheet("color: rgb(0, 0, 255)")
        self.lbl_map_txt.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_map_txt.setObjectName("lbl_map_txt")
        self.horizontalLayout_16.addWidget(self.lbl_map_txt)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_map.setText(_translate("MainWindow", "get latest forecast"))
        self.lbl_map_txt.setText(_translate("MainWindow", "LOADING..."))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_map), _translate("MainWindow", "Maps"))
