...
"font: 19pt \"DejaVu Sans\";")
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.tab_recipes)
        ...
        self.gridLayout_6.addItem(spacerItem29, 4, 1, 1, 1)
        ...
        self.gridLayout_6.addItem(spacerItem31, 2, 1, 1, 1)
        ...
        self.chk_rerun = QtWidgets.QCheckBox(self.tab_recipes)
        ...
        self.tabs.addTab(self.tab_recipes, "")
        ...
        self.btn_g_next_logger = QtWidgets.QPushButton(self.tab_graph)
        self.btn_g_next_logger.setObjectName("btn_g_next_logger")
        self.lay_g_h1.addWidget(self.btn_g_next_logger)
        self.lbl_g_cycle_haul = QtWidgets.QLabel(self.tab_graph)
        self.lbl_g_cycle_haul.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab_more_info), _translate("MainWindow", " More Info"))
        self.chk_rerun.setText(_translate("MainWindow", " Run logger after download"))
        self.tabs.setTabText(self.tabs.indexOf(self.tab_recipes), _translate("MainWindow", "Recipes"))
        self.lbl_g_paint_zones.setText(_translate("MainWindow", "TextLabel"))
        self.btn_g_reset.setText(_translate("MainWindow", "reset view"))
        self.btn_g_next_logger.setText(_translate("MainWindow", "next logger"))
        self.lbl_g_cycle_haul.setText(_translate("MainWindow", "TextLabel"))
        self.btn_g_next_haul.setText(_translate("MainWindow", "next haul"))
